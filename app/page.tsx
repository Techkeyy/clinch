  ...
  return (
    <section className="decision-interpretation" aria-label="Decision interpretation">
      ...
      <div className="decision-trigger-block">
        <p className="interpretation-label">WHAT WOULD CHANGE THE READ</p>
      ...
      <p className="decision-unresolved"><strong>Still open.</strong> {String(implication.unresolvedPoint ?? "The remaining decision question is held open for the human decision.")}</p>
    </section>
  );
}
